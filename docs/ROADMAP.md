...
## ✅ Currently Supported Languages (v0.0.1)

| Language | Script | Code | Status |
|----------|--------|------|--------|
| 🇮🇳 Tamil | Tamil | `ta` | ✅ Complete |
| 🇮🇳 Hindi | Devanagari | `hi` | ✅ Complete |
| 🇮🇳 Telugu | Telugu | `te` | ✅ Complete |
| 🇮🇳 Kannada | Kannada | `kn` | ✅ Complete |
| 🇮🇳 Malayalam | Malayalam | `ml` | ✅ Complete |
| 🇪🇸 Spanish | Latin | `es` | ✅ Complete |
